        ...
        */
        ...
        function MouseWheelHandler(e) {
            ...
            if(options.autoScrolling && !controlPressed && !isNormalScroll){
                ...
                console.log('MouseWheelHandler before', canScroll)
                if(canScroll){
                    console.log('MouseWheelHandler after', canScroll)
                    ...
                    if(isAccelerating && isScrollingVertically){
						console.log("TCL: MouseWheelHandler -> isAccelerating && isScrollingVertically", isAccelerating)
        ...
        */
        function performMovement(v){
            ...
            if (options.css3 && options.autoScrolling && !options.scrollBar) {
                console.log('performMovement', options.scrollingSpeed)
